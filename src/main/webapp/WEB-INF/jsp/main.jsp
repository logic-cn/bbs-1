...
<div class="panel panel-default" id="main" style="width: 70%;margin:1% 2% 5% 5%;float: left;">
    ...
    <div class="panel-heading" style="background-color: white">
        <a style="margin-left: 2%" href="<%=basePath%>">所有</a>
        <a style="margin-left: 2%" href="<%=basePath%>toMainPage.do?type=1">置顶</a>
        <a style="margin-left: 2%" href="<%=basePath%>toMainPage.do?type=2">活跃</a>
<%--        <a style="margin-left: 2%">精华</a>--%>
        <a style="margin-left: 2%" href="<%=basePath%>toMainPage.do?type=3">最近</a>
        <a style="margin-left: 2%" href="<%=basePath%>toMainPage.do?type=4">结帖</a>
    </div>

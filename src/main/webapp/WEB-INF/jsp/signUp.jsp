    ...
    <div class="panel-body">
        <form action="userSignUp.do" method="POST" id="mySignUpForm" class="form-horizontal" role="form"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6" style="width: 40%;">
                    <input type="text" class="form-control" id="user_college" name="user_college"/>
                    <span id="userCollegeErr" style="color:red"></span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6" style="width: 40%;">
                    ...
                    <span id="userMajorErr" style="color:red"></span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6" style="width: 40%;">
                    ...
                    <span id="userGradeErr" style="color:red"></span>
                </div>
            </div>
            <div class="form-group">

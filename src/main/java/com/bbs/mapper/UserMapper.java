...
public interface UserMapper {
    ...
    @Insert("INSERT INTO user " +
            "(user_name, user_nick, user_password, user_type, user_college, user_major, user_grade, user_status ) " +
            "VALUES (#{user_name}, #{user_nick}, #{user_password}, #{user_type}, #{user_college}, #{user_major}, #{user_grade}, #{user_status} " +
            ")")
